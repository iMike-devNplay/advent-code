...
public class MainAoc2024 
{

	public MainAoc2024(String day)
	{
		MainAoc.log("##################################");
		...
		m13.doPartAll();
		Main14 m14 = new Main14("Restroom Redoubt", "2024");
		m14.doPartAll();
		Main15 m15 = new Main15("Warehouse Woes", "2024");
		m15.doPartAll();
		Main16 m16 = new Main16("Reindeer Maze", "2024"); // Part 1 and 2 To improve
		m16.doPartAll();
		Main17 m17 = new Main17("Chronospatial Computer", "2024"); // Part2 to improve
		m17.doPartAll();
